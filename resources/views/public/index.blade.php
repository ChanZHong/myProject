...
<div class="page-wrapper">
  ...
  <header class="main-header-block sticky-header">
    <div class="container">
      <div class="logo">
        <figure> <a href="index.html"><img src="./skin/img/logo.png" alt=""></a> </figure>
      </div>
  ...
  <section class="rev_slider_wrapper">
    <div id="slider1" class="rev_slider"  data-version="5.0">
      <ul>
        <li data-transition="fade"> <img src="./skin/img/slider/1.jpg"  alt="" width="1920" height="550" data-bgposition="top center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="1" >
        ...
        <li data-transition="fade"> <img src="./skin/img/slider/2.jpg"  alt="" width="1920" height="580" data-bgposition="top center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="1" >
          <div class="tp-caption  tp-resizeme"
                        data-x="center" data-hoffset="0"
                        data-y="top" data-voffset="160"
                        data-transform_idle="o:1;"
  ...
  <!--Vedio Section-->
  <section class="vedio-area" style="background: url(./skin/img/background/1.jpg);">
    ...
    <div class="container">
      ...
      <div class="service-carousel three-column-carousel">
        <div class="slide-item-box">
          <div class="item-holder-box">
            <div class="image-box">
              <figure> <a href="service-details"><img src="./skin/img/services/1.jpg" alt=""></a> </figure>
            </div>
        ...
        <div class="slide-item-box">
          <div class="item-holder-box">
            <div class="image-box">
              <figure> <a href="service-details"><img src="./skin/img/services/2.jpg" alt=""></a> </figure>
            </div>
            <div class="image-text"> <a href="service-details">
        ...
        <div class="slide-item-box">
          <div class="item-holder-box">
            <div class="image-box">
              <figure> <a href="service-details"><img src="./skin/img/services/3.jpg" alt=""></a> </figure>
            </div>
            <div class="image-text"> <a href="service-details">
    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
          <div class="image-box">
            <figure> <img src="./skin/img/resource/1.jpg" alt=""> </figure>
          </div>
        </div>
        <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
          <div class="content-box">
            <div class="slider-pager">
              <ul class="list-inline thumb-box">
                <li> <a class="active" data-slide-index="0" href="#"><img src="./skin/img/testimonials/1.png" alt=""></a> </li>
                <li> <a data-slide-index="1" href="#"><img src="./skin/img/testimonials/2.png" alt=""></a> </li>
                <li> <a data-slide-index="2" href="#"><img src="./skin/img/testimonials/3.png" alt=""></a> </li>
              </ul>
            </div>
            <ul class="bxslider ">
              <li>
      ...
      <div class="row">
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="image-holder-block">
            <div class="image-box">
              <figure> <a href="#"><img src="./skin/img/team/1.jpg" alt=""></a> </figure>
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="image-holder-block">
            <div class="image-box">
              <figure> <a href="#"><img src="./skin/img/team/2.jpg" alt=""></a> </figure>
              <ul class="social-links text-center">
                <li><a href="#"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
                <li><a href="#"><i class="fa fa-linkedin" aria-hidden="true"></i></a></li>
                <li><a href="#"><i class="fa fa-twitter" aria-hidden="true"></i></a></li>
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="image-holder-block">
            <div class="image-box">
              <figure> <a href="#"><img src="./skin/img/team/3.jpg" alt=""></a> </figure>
              <ul class="social-links text-center">
                <li><a href="#"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
                <li><a href="#"><i class="fa fa-linkedin" aria-hidden="true"></i></a></li>
                <li><a href="#"><i class="fa fa-twitter" aria-hidden="true"></i></a></li>
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="image-holder-block">
            <div class="image-box">
              <figure> <a href="#"><img src="./skin/img/team/4.jpg" alt=""></a> </figure>
              <ul class="social-links text-center">
                <li><a href="#"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
                <li><a href="#"><i class="fa fa-linkedin" aria-hidden="true"></i></a></li>
                <li><a href="#"><i class="fa fa-twitter" aria-hidden="true"></i></a></li>
  ...
  <!--End team section-->
  <!--Fact Counter-->
  <section class="fact-counter-area" style="background: url(./skin/img/background/2.jpg);">
    <div class="container">
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-4 col-sm-12 col-xs-12">
          <div class="item-holder-box">
            <div class="image-box">
              <figure> <a href="#"><img src="./skin/img/blog/1.jpg" alt=""></a> </figure>
        ...
        <div class="col-md-4 col-sm-12 col-xs-12">
          <div class="item-holder-box">
            <div class="image-box">
              <figure> <a href="#"><img src="./skin/img/blog/2.jpg" alt=""></a> </figure>
              <div class="date-box"> <span>01 Oct, 2017</span> </div>
            </div>
            <div class="content-text">
              <div class="sec-title"> <a href="#">
        ...
        <div class="col-md-4 col-sm-12 col-xs-12">
          <div class="item-holder-box">
            <div class="image-box">
              <figure> <a href="#"><img src="./skin/img/blog/3.jpg" alt=""></a> </figure>
              <div class="date-box"> <span>01 Oct, 2017</span> </div>
            </div>
            <div class="content-text">
              <div class="sec-title"> <a href="#">
  ...
  <!--End blog section-->
  <!-- Contact Section -->
  <section class="contact-section" style="background: url(./skin/img/background/1.png);">
    <div class="container">
  ...
  <!-- End Contact Section -->
  <!--main-footer-area-->
  <footer class="main-footer-area" style="background: url(./skin/img/background/3.jpg);">
        ...
        <div class="row">
          <div class="col-md-3 col-sm-6 col-xs-12">
            <div class="about-widget-box">
              <div class="footer-logo">
                <figure> <a href="index.html"><img src="./skin/img/logo-2.png" alt=""></a> </figure>
              </div>
              <p>Lorem ipsum dolor sit amet consectetuer adipiscing elit sed diam nonummy Lorem ipsum dolor sit amet consectetuer.</p>
              <ul class="social-links">
                <li><a href="#"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
          ...
          <div class="col-md-4 col-sm-6 col-xs-12">
            <div class="footer-gallery-widget">
              ...
              <div class="clearfix">
                <figure class="image"> <img src="./skin/img/gallery/1.jpg" alt=""> <a href="./skin/img/gallery/1.jpg" class="lightbox-image" title=""><i class="fa fa-plus" aria-hidden="true"></i></a> </figure>
                <figure class="image"> <img src="./skin/img/gallery/2.jpg" alt=""> <a href="./skin/img/gallery/2.jpg" class="lightbox-image" title=""><i class="fa fa-plus" aria-hidden="true"></i></a> </figure>
                <figure class="image"> <img src="./skin/img/gallery/3.jpg" alt=""> <a href="./skin/img/gallery/4.jpg" class="lightbox-image" title=""><i class="fa fa-plus" aria-hidden="true"></i></a> </figure>
                <figure class="image"> <img src="./skin/img/gallery/4.jpg" alt=""> <a href="./skin/img/gallery/4.jpg" class="lightbox-image" title=""><i class="fa fa-plus" aria-hidden="true"></i></a> </figure>
                <figure class="image"> <img src="./skin/img/gallery/5.jpg" alt=""> <a href="./skin/img/gallery/5.jpg" class="lightbox-image" title=""><i class="fa fa-plus" aria-hidden="true"></i></a> </figure>
                <figure class="image"> <img src="./skin/img/gallery/6.jpg" alt=""> <a href="./skin/img/gallery/6.jpg" class="lightbox-image" title=""><i class="fa fa-plus" aria-hidden="true"></i></a> </figure>
              </div>
            </div>
          </div>
        </div>
...
<script src="./skin/revolution/js/jquery.themepunch.tools.min.js"></script>
<script src="./skin/revolution/js/jquery.themepunch.revolution.min.js"></script>
<script src="./skin/revolution/js/extensions/revolution.extension.actions.min.js"></script>
<script src="./skin/revolution/js/extensions/revolution.extension.carousel.min.js"></script>
<script src="./skin/revolution/js/extensions/revolution.extension.kenburn.min.js"></script>
<script src="./skin/revolution/js/extensions/revolution.extension.layeranimation.min.js"></script>
<script src="./skin/revolution/js/extensions/revolution.extension.migration.min.js"></script>
<script src="./skin/revolution/js/extensions/revolution.extension.navigation.min.js"></script>
<script src="./skin/revolution/js/extensions/revolution.extension.parallax.min.js"></script>
<script src="./skin/revolution/js/extensions/revolution.extension.slideanims.min.js"></script>
<script src="revolution/js/extensions/revolution.extension.video.min.js"></script>
<script src="./skin/js/owl.carousel.min.js"></script>
<script src="./skin/js/wow.js"></script>
<!-- bxslider -->
<script src="./skin/js/bxslider.js"></script>
